...
class AuthorController extends AbstractController
{
    ...
    {
        $author = new Author();
        $form = $this->createForm(Author2Type::class, $author);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $entityManager->flush();
            // $bookData = $request->request->get('book'); // Assuming you have a book field in the form
            // $book = new Book();
